...
public enum TelegramMessagesToUser {
    ...
    currentBalance("На сегодняшний день текущий investBot'a \n"),


    messageRecommendedPurchase(), messageRecommendedClose(), START_INSTRUCTION("/start - напишите для начала...\n" +
            "/currentBalance - отправьте команду, чтобы узнать текущий баланс публичного портфеля(ps:в моем закрытом портфеле в сообщение нули не помещаются :))" +
